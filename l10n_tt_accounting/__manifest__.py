...
This module prepares Odoo Community + Odoo Mates Accounting for Trinidad & Tobago:
- Sets company country and fiscal country to Trinidad & Tobago
...
- Sets 12.5% VAT as default sales and purchase tax
...
This module does not replace Odoo Mates Accounting. It configures Trinidad & Tobago defaults on top of the accounting engine.
''',
