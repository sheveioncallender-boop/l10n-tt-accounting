...
class L10nTTSetup(models.Model):
    ...
    bir_number = fields.Char(related='company_id.l10n_tt_bir_number', readonly=False, string='BIR Number')
    vat_registration_number = fields.Char(related='company_id.l10n_tt_vat_number', readonly=False, string='VAT Registration Number')
    company_registration_number = fields.Char(related='company_id.l10n_tt_company_registration_number', readonly=False, string='Company Registration Number')
    paye_registration_number = fields.Char(related='company_id.l10n_tt_paye_registration_number', readonly=False, string='PAYE Registration Number')
    nis_employer_number = fields.Char(related='company_id.l10n_tt_nis_employer_number', readonly=False, string='NIS Employer Number')
    business_activity = fields.Char(related='company_id.l10n_tt_business_activity', readonly=False, string='Business Activity')
    ...
    def action_run_readiness_audit(self):
        for setup in self:
            ...
            add('BIR Number configured', bool(company.l10n_tt_bir_number), 'Missing')
            add('VAT Registration Number configured', bool(company.l10n_tt_vat_number or not company.l10n_tt_enable_vat),
                'Missing for VAT registered company' if company.l10n_tt_enable_vat else 'Not VAT registered')
            add('PAYE Registration Number configured', bool(company.l10n_tt_paye_registration_number), 'Missing')
            add('NIS Employer Number configured', bool(company.l10n_tt_nis_employer_number), 'Missing')
            add('Company Registration Number configured', bool(company.l10n_tt_company_registration_number), 'Missing')
